...
const NFTDescription: React.FC<NFTDescriptionProps> = ({ nft }) => {
    ...
    const { buyNFT, account } = useContext(NFTMarketplaceContext);
                    ...
                    <div className={Style.NFTDescription_box_profile_box}>
                        <div className={Style.NFTDescription_box_profile_box_left}>
                            ...
                            <div className={Style.NFTDescription_box_profile_box_left_info}>
                                ...
                                <Link href={{ pathname: "/author-profile", query: { seller: nft.seller } }}>
                                    <span>
